	...
	<main>
		<div id="banner">
			...
			<div class="banner-img">
				<img src="./assets/images/slideshow/slide1.jpg" alt="Banner img1">
				<p>Impressions tous formats <span>en boutique et en ligne</span></p>
			</div>
			<div class="banner-img">
				<img src="./assets/images/slideshow/slide2.jpg" alt="Banner img2">
				<p>Impressions tous formats <span>en boutique et en ligne</span></p>
			</div>
			<div class="banner-img">
				<img src="./assets/images/slideshow/slide3.jpg" alt="Banner img3">
				<p>Impressions tous formats <span>en boutique et en ligne</span></p>
			</div>
			<div class="banner-img">
				<img src="./assets/images/slideshow/slide4.png" alt="Banner img4">
				<p>Impressions tous formats <span>en boutique et en ligne</span></p>
			</div>!
			...
			<!--Arrow-->
			<div class="arrow">
				<img class="arrow_left" src="./assets/images/arrow_left.png" alt="Banner arrow left">
				<img class="arrow_right" src="./assets/images/arrow_right.png" alt="Banner arrow right">
			</div>
